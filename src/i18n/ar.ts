...
export const ar: Translations = {
  ...
  timeline: {
    ...
    tooltipAdvanced: "الجدول الزمني للمواقع: كل نقطة تمثل موقعًا تراثيًا موضوعًا في تاريخ تدميره. انقر فوق نقطة لتحديد ذلك الموقع على الخرائط وفي قائمة المواقع؛ استخدم السابق/التالي للتنقل بين الأحداث. انتقل إلى تبويب الصور للتنقل بين تواريخ صور الأقمار الصناعية المتاحة بدلاً من ذلك.",
